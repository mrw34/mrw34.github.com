...
These diversions are included on the map below ([GPX](/assets/New%20River%20Path.gpx)). The resulting route is ~43km. Additionally, there are minor, temporary diversions near Bull’s Cross due to resurfacing work on the path. These are relatively easy to navigate and are not included on the map.
